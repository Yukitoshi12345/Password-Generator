...
function generatePassword() {
  passwordCharacterCount = window.prompt(
    "Please select the desired password length, ranging from 8 to 128 characters."
  );
  ...
  for (var i = 0; i < passwordCharacterCount; i++) {
    var randomPassword =
      userPreference[Math.floor(Math.random() * userPreference.length)];
